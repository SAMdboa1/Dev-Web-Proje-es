Variável: a variável é um espaço na memória onde será reservado o armazenamento do valor, você poderá alterar essas infomrações durante a execução
  exemplos
  let nome = "Júnior";
let idade = 35;
...
os tipos de dados compostos são:
